...
{
    public class AtencionApiController : ApiController
    {
        private readonly Data.UnitOfWork unitOfWork;
        private readonly Repositories.AudioAtencionRepository audioAtencionRepository;

        public AtencionApiController()
        {
        ...
        public HttpResponseMessage GetRecording(Int32 id)
        {
            ...
            var atencionEntity = unitOfWork
                .AtencionRepository()
                .GetById(id);

            if (atencionEntity.FechaEmision.Date < DateTime.Today.Date)
            {
                return null;
            }
