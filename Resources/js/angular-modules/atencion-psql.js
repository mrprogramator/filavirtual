angular.module('CatalogoApp')
    .controller('AtencionPSQLController', function ($http, $sce, $location) {
        self = this;
        ...
        getAtencion = function (id) {
            var promise = $http({
                method: 'POST',
                url: 'filavirtual/atenciones-pasadas/' + id
            })
        ...
        getAtenciones = function () {
            var promise = $http({
                method: 'POST',
                url: 'filavirtual/atenciones-pasadas'
            })
            .success(function (data, status, headers, config) {
                return data;
            })
        ...
        getAtencionesRange = function (inicio, fin, nroAgente) {
            var promise = $http({
                method: 'POST',
                url: 'filavirtual/atenciones-pasadas/' + inicio + '/' + fin + '/' + nroAgente
            })
            .success(function (data, status, headers, config) {
                return data;
            })
        ...
        getAtencionesByTicket = function (inicio, fin, nroTicket, nroAgente) {
            var promise = $http({
                method: 'POST',
                url: 'filavirtual/atenciones-pasadas/tickets/' + nroTicket + '/' + inicio + '/' + fin + '/' + nroAgente
            })
            .success(function (data, status, headers, config) {
                return data;
            })
        ...
        getAudio = function (id) {
            var promise = $http({
                method: 'POST',
                url: 'filavirtual/atenciones-pasadas/' + id + '/audio'
            })
            .success(function (data, status, headers, config) {
                return data;
            })
        ...
        downloadAudio = function (id) {
            var promise = $http({
                method: 'POST',
                url: 'filavirtual/atenciones-pasadas/' + id + '/audio/download'
            })
            .success(function (data, status, headers, config) {
                return data;
            })
        ...
        getTransacciones = function (id) {
            return promise = $http({
                method: 'POST',
                url: 'filavirtual/DetalleAtencionPSQL/GetTransacciones/?atencionId=' + id
            })
            .success(function (data, status, headers, config) {
                return data;
            })
        ...
        this.index = function (tab) {
            tab.templateUrl = 'filavirtual/AtencionPSQL/?ajax=1&_=' + Date.now();
        }

        this.create = function (tab) {
            tab.templateUrl = 'filavirtual/AtencionPSQL/Create/?ajax=1&_=' + Date.now();
        }

        this.edit = function (tab, id) {
            tab.templateUrl = 'filavirtual/AtencionPSQL/Edit/?id=' + id + '&ajax=1&_=' + Date.now();
        }
        ...
        this.detail = function (tab, id) {
            tab.templateUrl = 'filavirtual/atenciones-pasadas/' + id + '/detail?ajax=1&_=' + Date.now();
        }

        this.transacciones = function (tab, id) {
            tab.templateUrl = 'filavirtual/atenciones-pasadas/' + id + '/transacciones?ajax=1&_=' + Date.now();
        }
        ...
        self.detailInit = function (tab) {
            ...
            var atencion_id = params[params.indexOf('atenciones-pasadas') + 1];
            getAtencion(atencion_id).then(function (promise) {
                ...
                self.item.FechaEmision = new Date(fechaUnicode);

                fechaStr = self.item.FechaLlamado;
                fechaUnicode = fechaStr.substring(6, fechaStr.length - 2) * 1;
                self.item.FechaLlamado = new Date(fechaUnicode);

                fechaStr = self.item.FechaInicio;
                fechaUnicode = fechaStr.substring(6, fechaStr.length - 2) * 1;
                self.item.FechaInicio = new Date(fechaUnicode);

                fechaStr = self.item.FechaFin;
                fechaUnicode = fechaStr.substring(6, fechaStr.length - 2) * 1;
                self.item.FechaFin = new Date(fechaUnicode);
        ...
        this.getAudioURL = function (item) {
            return 'api/AtencionPSQLApi/GetRecording/' + item.Id;
        };
