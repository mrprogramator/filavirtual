      ...
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          if (attrs.iconExpand == null) {
            attrs.iconExpand = 'icon-folder-close  glyphicon glyphicon-folder-close  fa fa-folder-close';
          }
