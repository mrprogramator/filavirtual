/*
* TelerikReporting v8.0.14.507 (http://www.telerik.com/products/reporting.aspx)
...
(function(trv, $, window, document, undefined) {
    ...
    function ReportViewerController(options) {
        var controller = {}, $controller = $(controller), clientId, reportInstanceId, reportDocumentId, registerClientDfd, reportInstanceDfd, getDocumentFormatsDfd, report, parameterValues, currentPageNumber, pageCount, viewMode = trv.ViewModes.INTERACTIVE, documentFormats, loader, directPrint;
        options = jQuery.extend({}, defaultOptions, options);
        if (options.settings.directPrint) {
            directPrint = options.settings.directPrint();
        }
        ...
        function printReport() {
            throwIfNoReport();
            onPrintStarted();
            if (directPrint === undefined) {
                directPrint = printManager.getDirectPrintState();
            }
            var contentDisposition = directPrint ? "inline" : "attachment";
...
(function(trv, $, window, document, undefined) {
    ...
    function ReportViewerSettings(id, storage, defaultSettings) {
        ...
        $this = $.extend($this, {
            ...
            directPrint: function() {
                return value("directPrint", arguments);
            }
        });
        return $this;
    }
    ...
    function ReportViewer(dom, options) {
        ...
        var settings = new ReportViewerSettings(persistanceKey, options.persistSession ? window.sessionStorage : new MemStorage(), {
            ...
            directPrint: options.directPrint
        });
