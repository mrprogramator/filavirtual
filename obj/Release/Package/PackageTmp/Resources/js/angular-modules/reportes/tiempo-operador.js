angular.module('ReporteApp')
    .controller('TiempoOperadorController', function ($scope, $http, $timeout) {
        ...
        $scope.makeReport = function (tab) {
            $timeout(function () {
                ...
                var typeName = "SistemaDeGestionDeFilas.Reports.TiempoOperador,SistemaDeGestionDeFilas"
                var parameters = [
                        {
                            Name: "fechaInicio",
                ...
                getReport(typeName, parameters).then(function (promise) {
                    ...
                    $('#report-tiop-div').html(promise.data);
                });
