angular.module('ReporteApp')
    .controller('TransaccionesPorParametricaController', function ($scope, $http, $timeout) {
        ...
        $scope.makeReport = function (tab) {
            $timeout(function () {
                ...
                var typeName = "SistemaDeGestionDeFilas.Reports.TransaccionesPorParametrica,SistemaDeGestionDeFilas"
                var parameters = [
                        {
                            Name: "fechaInicio",
                ...
                getReport(typeName, parameters).then(function (promise) {
                    ...
                    $('#report-trpar-div').html(promise.data);
                });
                console.log(typeName, parameters);

                //showReport(tab, typeName, parameters);
